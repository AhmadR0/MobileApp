...
import { CameraView } from 'expo-camera'; // Import CameraView dari Expo
import { useCameraPermissions } from 'expo-camera'; 

export default function ScanTabungMasuk() {
...
const styles = StyleSheet.create({
  ...
  frame: {
    ...
    borderRadius: 10,
    backgroundColor: 'transparent', // just the border visible
  },
});
